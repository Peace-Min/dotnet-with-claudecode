...
// path is not configured, with a message pointing to /wpf-net472-airgap-dev-pack:set-repo-path.
...
var reason =
    ...
    "/wpf-net472-airgap-dev-pack:set-repo-path <path-to-local-clone-of-christian289/dotnet-with-claudecode>.";
...
static bool IsConfigured()
{
    ...
    var configPath = Path.Combine(
        ...
        ".wpf-net472-airgap-dev-pack-mcp", "config.json");
