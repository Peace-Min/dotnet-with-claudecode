...
| **FeedbackDocAuditor** | PostToolUse (스킬 스코프) | `*-wpf-net472-airgap-dev-pack-feedback.md` 파일을 개인 식별 정보에 대해 감사하고 위반 시 종료 코드 2로 진단을 모델에 전달. `hooks.json`이 아닌 `skills/collecting-wpf-net472-airgap-dev-pack-feedback/SKILL.md` frontmatter에 등록되어, 해당 스킬이 활성화된 동안에만 발화함. |
