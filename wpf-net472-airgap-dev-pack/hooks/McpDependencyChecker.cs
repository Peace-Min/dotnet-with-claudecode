...
var cacheFile = Path.Combine(tempDir, $"wpf-net472-airgap-dev-pack-mcp-check-{today}.txt");
...
// Required MCP servers for wpf-net472-airgap-dev-pack agents
// wpf-net472-airgap-dev-pack 에이전트에 필요한 MCP 서버
...
Console.WriteLine($$"""
    ...
    📦 Install missing MCPs by adding to ~/.claude/.mcp.json:
       See: https://github.com/christian289/dotnet-with-claudecode/tree/main/wpf-net472-airgap-dev-pack#required-mcp-dependencies
