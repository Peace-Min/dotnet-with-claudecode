...
//
// At the start of every Claude Code session where the wpf-net472-airgap-dev-pack plugin is
...
Console.Write(
    """
    [wpf-net472-airgap-dev-pack] WPF ControlTemplate / Style / animation authoring rules — ENFORCED this session.
