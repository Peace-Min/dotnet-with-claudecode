...
// wpf-net472-airgap-dev-pack plugin is installed, this hook checks for the file
// .claude/wpf-net472-airgap-dev-pack.local.md. If the file exists and a `language:`
...
//   /wpf-net472-airgap-dev-pack:configuring-wpf-net472-airgap-dev-pack-language
//
...
var configPath = Path.Combine(".claude", "wpf-net472-airgap-dev-pack.local.md");
...
Console.WriteLine($"[wpf-net472-airgap-dev-pack] Per-project language preference active: {displayName} (`{lang}`).");
Console.WriteLine();
Console.WriteLine($"For the remainder of this session, respond to the user in {displayName} (BCP-47 `{lang}`).");
Console.WriteLine("This overrides any conflicting default language preference for wpf-net472-airgap-dev-pack-scoped interactions.");
Console.WriteLine("Skill content language policy (SKILL.md body, code comments) is unaffected — it remains English.");
Console.WriteLine();
Console.WriteLine("Source: .claude/wpf-net472-airgap-dev-pack.local.md");
Console.WriteLine("To change: run /wpf-net472-airgap-dev-pack:configuring-wpf-net472-airgap-dev-pack-language");
