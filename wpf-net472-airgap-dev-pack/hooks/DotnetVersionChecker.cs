...
//
// wpf-net472-airgap-dev-pack ships hooks as C# file-based apps (`dotnet <file.cs>`),
...
var cachePath = Path.Combine(Path.GetTempPath(),
    $"wpf-net472-airgap-dev-pack-dotnet-check-{DateTime.Now:yyyy-MM-dd}.txt");
...
{
    Console.WriteLine();
    Console.WriteLine($"{Red}{Bold}!!! [wpf-net472-airgap-dev-pack] .NET SDK NOT FOUND !!!{Reset}");
    Console.WriteLine();
    Console.WriteLine($"{Red}wpf-net472-airgap-dev-pack hooks are C# file-based apps and REQUIRE{Reset}");
...
{
    Console.WriteLine();
    Console.WriteLine($"{Red}{Bold}!!! [wpf-net472-airgap-dev-pack] .NET SDK TOO OLD !!!{Reset}");
    Console.WriteLine();
    ...
    Console.WriteLine();
    Console.WriteLine($"{Red}Until updated, wpf-net472-airgap-dev-pack hooks may misbehave due to{Reset}");
