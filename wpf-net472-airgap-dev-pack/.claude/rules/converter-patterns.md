...
Standards for implementing `IValueConverter` in wpf-net472-airgap-dev-pack projects.
...
matching the `/wpf-net472-airgap-dev-pack:make-wpf-converter` scaffolder and the
