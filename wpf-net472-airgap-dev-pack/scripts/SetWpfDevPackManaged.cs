...
// Sets the 'Managed' flag in ~/.wpf-net472-airgap-dev-pack-mcp/state.json (preserving
...
if (managed is null)
{
    ...
    Console.Error.WriteLine("Usage: /wpf-net472-airgap-dev-pack:set-repo-managed <true|false>");
    return 1;
}
