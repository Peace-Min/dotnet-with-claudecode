...
Console.WriteLine(ReadOrNote(configPath, "(not found — run /wpf-net472-airgap-dev-pack:set-repo-path <path> to create it)"));
Console.WriteLine();
...
Console.WriteLine("Change values with: /wpf-net472-airgap-dev-pack:set-repo-path, /wpf-net472-airgap-dev-pack:set-repo-branch, /wpf-net472-airgap-dev-pack:set-repo-managed");
