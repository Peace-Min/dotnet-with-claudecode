...
// Sets the 'branch' field in ~/.wpf-net472-airgap-dev-pack-mcp/config.json (the branch the
...
if (string.IsNullOrWhiteSpace(branch))
{
    ...
    Console.Error.WriteLine("Usage: /wpf-net472-airgap-dev-pack:set-repo-branch <branch>");
    return 1;
}
...
if (repoPath is null)
    Console.WriteLine("  ! repoPath is not set yet — run /wpf-net472-airgap-dev-pack:set-repo-path <path> to make the MCP usable.");
