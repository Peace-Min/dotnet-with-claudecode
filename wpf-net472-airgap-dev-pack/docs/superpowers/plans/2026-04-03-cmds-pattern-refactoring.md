...
Run: `ls .claude/rules/` from the wpf-net472-airgap-dev-pack directory.
...
Run: `head -70 agents/wpf-architect.md` from wpf-net472-airgap-dev-pack directory.
...
Run: `head -35 agents/wpf-mvvm-expert.md` from wpf-net472-airgap-dev-pack directory.
...
Run: `tail -30 agents/wpf-code-reviewer.md` from wpf-net472-airgap-dev-pack directory.
...
Run: `tail -10 agents/wpf-control-designer.md` from wpf-net472-airgap-dev-pack directory.
...
Run: `head -40 agents/wpf-data-binding-expert.md` from wpf-net472-airgap-dev-pack directory.
...
Run: `grep -n "^###" agents/wpf-performance-optimizer.md` from wpf-net472-airgap-dev-pack directory.
...
Run: `grep -n "^###" agents/wpf-xaml-designer.md` from wpf-net472-airgap-dev-pack directory.
...
Run: `grep -n "^## " .claude/CLAUDE.md` from wpf-net472-airgap-dev-pack directory.
...
Run: `ls -1 .claude/rules/` from wpf-net472-airgap-dev-pack directory.
Expected: 9 files (3 existing + 6 new).

- [ ] **Step 2: Verify no duplicated rules remain in agents**

Run: `grep -l "No System.Windows references in ViewModel" agents/*.md` from wpf-net472-airgap-dev-pack directory.
Expected: NO matches (the literal string should only exist in `.claude/rules/mvvm-constraints.md` now).

Run: `grep -l "Generic.xaml serves only as MergedDictionaries hub" agents/*.md` from wpf-net472-airgap-dev-pack directory.
Expected: NO matches.

Run: `grep -l "brush.Freeze();  // REQUIRED" agents/*.md` from wpf-net472-airgap-dev-pack directory.
Expected: NO matches.

- [ ] **Step 3: Verify all agents reference @rules/**

Run: `grep -l "@rules/" agents/*.md` from wpf-net472-airgap-dev-pack directory.
Expected: All 7 agent files listed.

- [ ] **Step 4: Verify Essential section exists in CLAUDE.md**

Run: `grep "Essential (Post-Compact)" .claude/CLAUDE.md` from wpf-net472-airgap-dev-pack directory.
