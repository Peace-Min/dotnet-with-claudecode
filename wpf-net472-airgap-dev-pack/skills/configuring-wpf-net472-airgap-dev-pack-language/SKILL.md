---
description: "Configures the user-facing response language for the wpf-net472-airgap-dev-pack plugin by writing a per-project preference file at .claude/wpf-net472-airgap-dev-pack.local.md. Use when starting work with wpf-net472-airgap-dev-pack in a new project and the default language does not match the user's expectation, or when switching language mid-project. The setting is read by the LanguagePreferenceLoader SessionStart hook on the next conversation start and takes effect automatically from then on."
argument-hint: "[language-code]"
disable-model-invocation: true
---

# Configuring wpf-net472-airgap-dev-pack Language

This skill writes (or updates) a per-project preference file that tells
the wpf-net472-airgap-dev-pack plugin which language to respond in. A SessionStart
...
- The default language of a response does not match what the user wants
  ...
  wpf-net472-airgap-dev-pack was originally tuned for Korean responses, or vice versa).
...
- The wpf-net472-airgap-dev-pack plugin is not installed in the current project — the
...
```
Configure Progress:
- [ ] Step 1: Detect current state of .claude/wpf-net472-airgap-dev-pack.local.md
- [ ] Step 2: Resolve target language (argument or AskUserQuestion)
- [ ] Step 3: Write or update .claude/wpf-net472-airgap-dev-pack.local.md
- [ ] Step 4: Confirm and explain when the change takes effect
```

### Step 1 — Detect current state

Check whether `.claude/wpf-net472-airgap-dev-pack.local.md` exists in the current
...
If the file does not exist, create `.claude/wpf-net472-airgap-dev-pack.local.md`
...
# wpf-net472-airgap-dev-pack — Per-Project Local Settings

This file stores personal, per-project preferences for the wpf-net472-airgap-dev-pack
...
- This skill is intentionally NOT auto-triggered. Changing the
  ...
  invoked explicitly.
- The mechanism is wpf-net472-airgap-dev-pack scoped. Other plugins or workflows in
