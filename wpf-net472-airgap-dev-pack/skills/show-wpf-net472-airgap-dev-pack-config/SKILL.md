...
- `~/.wpf-net472-airgap-dev-pack-mcp/config.json` — user-written `repoPath` + `branch`
- `~/.wpf-net472-airgap-dev-pack-mcp/state.json` — server-managed `LastPullUtc` + `Managed`
...
To change values: `/wpf-net472-airgap-dev-pack:set-repo-path` (repoPath), `/wpf-net472-airgap-dev-pack:set-repo-branch` (branch), `/wpf-net472-airgap-dev-pack:set-repo-managed` (Managed flag).
