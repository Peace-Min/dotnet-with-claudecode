---
description: "Generates WPF IValueConverter or IMultiValueConverter classes with MarkupExtension pattern. Use when creating a new value converter, scaffolding a MultiValueConverter, or adding a converter with direct XAML usage. Usage: /wpf-net472-airgap-dev-pack:make-wpf-converter <ConverterName> [multi]"
...
/wpf-net472-airgap-dev-pack:make-wpf-converter AllTrue multi
```
