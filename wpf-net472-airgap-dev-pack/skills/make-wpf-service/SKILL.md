---
description: "Generates WPF service interface, implementation class, and DI registration. Use when adding a new service layer, creating a service with interface separation, or scaffolding a service class with DI wiring. Usage: /wpf-net472-airgap-dev-pack:make-wpf-service <ServiceName> [--no-interface]"
...
/wpf-net472-airgap-dev-pack:make-wpf-service DataExport

# Implementation only (no interface) — for simple services
/wpf-net472-airgap-dev-pack:make-wpf-service FileManager --no-interface
```
