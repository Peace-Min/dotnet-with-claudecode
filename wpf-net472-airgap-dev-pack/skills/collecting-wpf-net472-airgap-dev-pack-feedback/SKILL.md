...
hooks:
  PostToolUse:
    - matcher: Write
      hooks:
        - type: command
          if: "Write(*-wpf-net472-airgap-dev-pack-feedback.md)"
          command: dotnet "${CLAUDE_PLUGIN_ROOT}/hooks/FeedbackDocAuditor.cs"
          timeout: 10
    - matcher: Edit
      hooks:
        - type: command
          if: "Edit(*-wpf-net472-airgap-dev-pack-feedback.md)"
          command: dotnet "${CLAUDE_PLUGIN_ROOT}/hooks/FeedbackDocAuditor.cs"
          timeout: 10
---
...
Write the file to `<cwd>/<topic>-wpf-net472-airgap-dev-pack-feedback.md` (current working
...
`<topic>-wpf-net472-airgap-dev-pack-feedback.md`, nothing prepended.
...
```markdown
# wpf-net472-airgap-dev-pack Feedback — <one-line title>
...
first-pass audit on every Write/Edit of a `*-wpf-net472-airgap-dev-pack-feedback.md` file
...
- [ ] The filename itself carries no date prefix — it is exactly
      `<topic>-wpf-net472-airgap-dev-pack-feedback.md`, never `YYYY-MM-DD-<topic>-…`
