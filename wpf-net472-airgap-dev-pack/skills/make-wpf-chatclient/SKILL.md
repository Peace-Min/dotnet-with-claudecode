---
description: "One-button generator for a complete, runnable streaming LLM chat client in WPF (CommunityToolkit.Mvvm): markdown bubbles, provider-agnostic IChatClient with a shared HttpClient pool, MCP tools, Enter-to-send, and pin-to-bottom auto-scroll — defaulting to a keyless mock provider so it runs immediately. Use when adding a chat/assistant panel to a WPF app. Usage: /wpf-net472-airgap-dev-pack:make-wpf-chatclient <Name>"
argument-hint: [Name]
---
...
- Component scaffolders: `/wpf-net472-airgap-dev-pack:make-wpf-markdown-presenter`,
  `/wpf-net472-airgap-dev-pack:make-wpf-chat-bubble-template`,
  `/wpf-net472-airgap-dev-pack:make-wpf-chatclient-factory`,
  `/wpf-net472-airgap-dev-pack:make-wpf-chat-orchestrator`,
  `/wpf-net472-airgap-dev-pack:make-wpf-behavior` (the two behaviors above are instances of it).
