...
- The `IChatClient` is produced by `/wpf-net472-airgap-dev-pack:make-wpf-chatclient-factory`
...
> (the layout used by the one-button `/wpf-net472-airgap-dev-pack:make-wpf-chatclient`).
...
> emitted by the one-button `/wpf-net472-airgap-dev-pack:make-wpf-chatclient`. If the
...
- Sibling scaffolders: consumes the `IChatClient` from
  `/wpf-net472-airgap-dev-pack:make-wpf-chatclient-factory`. Emitted as part of the one-button
