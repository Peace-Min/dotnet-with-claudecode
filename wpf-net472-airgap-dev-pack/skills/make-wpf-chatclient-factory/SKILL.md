...
> `/wpf-net472-airgap-dev-pack:make-wpf-chatclient` lays them out. The implementation (`$0`,
...
- Sibling scaffolders: feeds `/wpf-net472-airgap-dev-pack:make-wpf-chat-orchestrator` (which
