...
/// <summary>User-written config (~/.wpf-net472-airgap-dev-pack-mcp/config.json).</summary>
public sealed record RepoConfig(string? RepoPath, string Branch = "main");

/// <summary>Server-managed pull state (~/.wpf-net472-airgap-dev-pack-mcp/state.json).</summary>
